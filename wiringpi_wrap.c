...
SWIGINTERN PyObject *_wrap_physPinToPin(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:physPinToPin",&obj0)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "physPinToPin" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
  {
    SWIG_PYTHON_THREAD_BEGIN_ALLOW;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "wiringPiFindNode", _wrap_wiringPiFindNode, METH_VARARGS, NULL},
	 { "wiringPiNewNode", _wrap_wiringPiNewNode, METH_VARARGS, NULL},
	 { "wiringPiSetup", _wrap_wiringPiSetup, METH_VARARGS, NULL},
	 { "wiringPiSetupSys", _wrap_wiringPiSetupSys, METH_VARARGS, NULL},
	 { "wiringPiSetupGpio", _wrap_wiringPiSetupGpio, METH_VARARGS, NULL},
	 { "wiringPiSetupPhys", _wrap_wiringPiSetupPhys, METH_VARARGS, NULL},
	 ...
	 { "digitalRead", _wrap_digitalRead, METH_VARARGS, NULL},
	 { "digitalWrite", _wrap_digitalWrite, METH_VARARGS, NULL},
	 { "pwmWrite", _wrap_pwmWrite, METH_VARARGS, NULL},
	 { "analogRead", _wrap_analogRead, METH_VARARGS, NULL},
	 { "analogWrite", _wrap_analogWrite, METH_VARARGS, NULL},
	 { "piBoardRev", _wrap_piBoardRev, METH_VARARGS, NULL},
	 { "piBoardId", _wrap_piBoardId, METH_VARARGS, NULL},
	 { "wpiPinToGpio", _wrap_wpiPinToGpio, METH_VARARGS, NULL},
	 { "physPinToGpio", _wrap_physPinToGpio, METH_VARARGS, NULL},
	 { "physPinToPin", _wrap_physPinToPin, METH_VARARGS, NULL},
	 { "setPadDrive", _wrap_setPadDrive, METH_VARARGS, NULL},
	 { "getAlt", _wrap_getAlt, METH_VARARGS, NULL},
	 { "pwmToneWrite", _wrap_pwmToneWrite, METH_VARARGS, NULL},
	 { "digitalWriteByte", _wrap_digitalWriteByte, METH_VARARGS, NULL},
	 { "pwmSetMode", _wrap_pwmSetMode, METH_VARARGS, NULL},
	 { "pwmSetRange", _wrap_pwmSetRange, METH_VARARGS, NULL},
	 { "pwmSetClock", _wrap_pwmSetClock, METH_VARARGS, NULL},
	 { "gpioClockSet", _wrap_gpioClockSet, METH_VARARGS, NULL},
	 { "waitForInterrupt", _wrap_waitForInterrupt, METH_VARARGS, NULL},
	 { "piThreadCreate", _wrap_piThreadCreate, METH_VARARGS, NULL},
	 { "piLock", _wrap_piLock, METH_VARARGS, NULL},
	 { "piUnlock", _wrap_piUnlock, METH_VARARGS, NULL},
	 { "piHiPri", _wrap_piHiPri, METH_VARARGS, NULL},
	 { "delay", _wrap_delay, METH_VARARGS, NULL},
	 { "delayMicroseconds", _wrap_delayMicroseconds, METH_VARARGS, NULL},
	 { "millis", _wrap_millis, METH_VARARGS, NULL},
	 { "micros", _wrap_micros, METH_VARARGS, NULL},
	 { "wiringPiI2CRead", _wrap_wiringPiI2CRead, METH_VARARGS, NULL},
	 ...
	 { "wiringPiI2CSetup", _wrap_wiringPiI2CSetup, METH_VARARGS, NULL},
	 { "wiringPiSPIGetFd", _wrap_wiringPiSPIGetFd, METH_VARARGS, NULL},
	 ...
	 { "serialClose", _wrap_serialClose, METH_VARARGS, NULL},
	 { "serialFlush", _wrap_serialFlush, METH_VARARGS, NULL},
	 ...
	 { "serialDataAvail", _wrap_serialDataAvail, METH_VARARGS, NULL},
	 { "serialGetchar", _wrap_serialGetchar, METH_VARARGS, NULL},
	 ...
	 { "sn3218Setup", _wrap_sn3218Setup, METH_VARARGS, NULL},
	 { "softPwmCreate", _wrap_softPwmCreate, METH_VARARGS, NULL},
	 { "softPwmWrite", _wrap_softPwmWrite, METH_VARARGS, NULL},
	 { "softPwmStop", _wrap_softPwmStop, METH_VARARGS, NULL},
	 { "softServoWrite", _wrap_softServoWrite, METH_VARARGS, NULL},
	 { "softServoSetup", _wrap_softServoSetup, METH_VARARGS, NULL},
	 { "softToneCreate", _wrap_softToneCreate, METH_VARARGS, NULL},
	 { "softToneStop", _wrap_softToneStop, METH_VARARGS, NULL},
	 { "softToneWrite", _wrap_softToneWrite, METH_VARARGS, NULL},
	 { "sr595Setup", _wrap_sr595Setup, METH_VARARGS, NULL},
	 { "ds1302rtcRead", _wrap_ds1302rtcRead, METH_VARARGS, NULL},
	 { "ds1302rtcWrite", _wrap_ds1302rtcWrite, METH_VARARGS, NULL},
	 { "ds1302ramRead", _wrap_ds1302ramRead, METH_VARARGS, NULL},
	 { "ds1302ramWrite", _wrap_ds1302ramWrite, METH_VARARGS, NULL},
	 { "ds1302clockRead", _wrap_ds1302clockRead, METH_VARARGS, NULL},
	 { "ds1302clockWrite", _wrap_ds1302clockWrite, METH_VARARGS, NULL},
	 ...
	 { "gertboardAnalogRead", _wrap_gertboardAnalogRead, METH_VARARGS, NULL},
	 { "gertboardSPISetup", _wrap_gertboardSPISetup, METH_VARARGS, NULL},
	 { "gertboardAnalogSetup", _wrap_gertboardAnalogSetup, METH_VARARGS, NULL},
	 { "lcd128x64setOrigin", _wrap_lcd128x64setOrigin, METH_VARARGS, NULL},
	 { "lcd128x64setOrientation", _wrap_lcd128x64setOrientation, METH_VARARGS, NULL},
	 ...
	 { "lcd128x64update", _wrap_lcd128x64update, METH_VARARGS, NULL},
	 { "lcd128x64clear", _wrap_lcd128x64clear, METH_VARARGS, NULL},
	 { "lcd128x64setup", _wrap_lcd128x64setup, METH_VARARGS, NULL},
	 { "lcdHome", _wrap_lcdHome, METH_VARARGS, NULL},
	 { "lcdClear", _wrap_lcdClear, METH_VARARGS, NULL},
	 ...
	 { "piGlowSetup", _wrap_piGlowSetup, METH_VARARGS, NULL},
	 { "setupNesJoystick", _wrap_setupNesJoystick, METH_VARARGS, NULL},
	 { "readNesJoystick", _wrap_readNesJoystick, METH_VARARGS, NULL},
	 { "piFaceSetup", _wrap_piFaceSetup, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
